...
const OysterPaymentBooking = (props) => {
  ...
  const { finalOysterCard, selectedZoneValue, selectedBookingDetails } =
    useSelector((state) => state.oysterCards);
  ...
  console.log(selectedBookingDetails, selectedBookingDetail, "booking details");
          ...
          <div>
            ...
            >
              ...
              <button
                ...
                onClick={() => {
                  if (!userProfileDetail?.card?.cardNumber) {
                    ...
                    // navigate('/myBookings')
                    let dta = finalOysterCard;
                    dta.price = selectedBookingDetails.durationPrice;
                    dispatch(purchaseOysterCardInitiate(dta, navigate));
                  }
                }}
              ...
              >
                {confirmTrainBookingLoader ? (
                  <Spin />
                ) : selectedBookingDetails?.durationPrice ? (
                  `Pay £${selectedBookingDetails?.durationPrice?.toFixed(2)}`
                ) : (
                  "Pay"
                )}
              </button>
                      ...
                      <div className="d-flex">
                        ...
                        <p>
                          {/* {!isObjEmpty(selectedBookingDetail)
                            ...
                            : "0"} */}
                          {selectedBookingDetail?.duraitonPrice}
                        </p>
                      </div>
                    </div>
                    <div className="first d-flex">
