                        ...
                        <div className="tree">
                          <div className="first d-flex">
                            <div className="d-flex space_edit">
                              <h2>Journey Type</h2>
                              <p>
                                {selectedBookingDetail?.JourneyType ===
                                "roundTrip"
                                  ? "RoundTrip"
                                  : "OneWay" || "N/A"}
                              </p>
                          ...
                          <div className="first d-flex">
                            <div className="d-flex space_edit">
                              <h2>Train No./Name</h2>
                              <p>
                                {selectedBookingDetail?.TrainNumber || "N/A"}
                              </p>
                            </div>
                            <div className="d-flex">
                              <h2>Booking Date</h2>
                          ...
                          <div className="first d-flex">
                            <div className="d-flex space_edit">
                              <h2>From Station</h2>
                              <p>
                                {selectedBookingDetail?.FromStation
                                  ?.StationName || "N/A"}
                              </p>
                            </div>
                            <div className="d-flex">
                              <h2>To Station</h2>
                              <p>
                                {selectedBookingDetail?.destination
                                  ?.StationName || "N/A"}
                              </p>
                            </div>
                          </div>
                          <div className="first d-flex">
                            <div className="d-flex space_edit">
                              <h2>Adult Count</h2>
                              <p>
                                {selectedBookingDetail?.AdultCount || "N/A"}
                              </p>
                            </div>
                            <div className="d-flex">
                              <h2>Children Count</h2>
                              <p>{selectedBookingDetail.ChildrenCount}</p>
                            </div>
                          </div>
                          <div className="first d-flex">
                            <div className="d-flex space_edit">
                              ...
                              <p>
                                {selectedBookingDetail?.DepartureDate
                                  ? moment(
                                      selectedBookingDetail?.DepartureDate
                                    ).format("HH:mm A")
                                  : "N/A"}
                            ...
                            <div className="d-flex">
                              <h2>Arrival Time</h2>
                              <p>
                                {selectedBookingDetail?.ArrivalDateTime
                                  ? moment(
                                      selectedBookingDetail?.ArrivalDateTime
                                    ).format("HH:mm A")
                                  : "N/A"}
                          ...
                          <div className="first d-flex ppaymer_tags">
                            <div className="d-flex">
                              <h2>Total Fare</h2>
                              <h2>{`£${selectedBookingDetail?.StandardFare}`}</h2>
                            </div>
                          </div>
                        </div>
                      )}
                          ...
                          <div className="tree">
                            ...
                            <div className="first d-flex">
                              ...
                              <div className="d-flex">
                                <h2>To Station</h2>
                                <p>
                                  {selectedBookingDetail?.returnDestination
                                    ?.StationName || "N/A"}
                                </p>
                              </div>
                            </div>
